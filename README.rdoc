{<img src="https://travis-ci.org/kilt-cms/kilt-cms.png?branch=master" alt="Build Status" />}[https://travis-ci.org/AsheAvenue/Kilt]
...
- Run the migrations. This will add one table to your application:
