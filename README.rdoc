...
If you would like to use RethinkDB as your datastore, you'll need to copy the rethinkdb example. Add your database info to the creds.yml. You should have a RethinkDB set up and running already, and you should probably use a Rails app that has no database.

- To create a new Rails app:

    $ rails new Blah

- To copy over the example RethinkDB configuration file, use:
